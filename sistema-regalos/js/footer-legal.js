            ...
            <div class="footer-content">
                ...
                <div class="row mb-5">
                    <div class="col-lg-4 mb-4 mb-lg-0">
                        <span style="font-size: 1.5rem; font-weight: 800; display: block; margin-bottom: 1rem; background: linear-gradient(135deg, #16a34a 0%, #15803d 50%, #dc2626 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;">🎄 COOMOTOR</span>
                    ...
                    <div class="col-lg-4 col-md-4">
                        ...
                        <div class="mt-3 p-3" style="background: rgba(255, 255, 255, 0.05); border-radius: 12px; border-left: 3px solid #16a34a;">
                            <p style="color: rgba(255, 255, 255, 0.8); font-size: 0.8rem; margin: 0; line-height: 1.6;">
                                <i class="bi bi-info-circle-fill me-2" style="color: #16a34a;"></i>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 text-center text-md-end">
                        <div class="d-flex justify-content-center justify-content-md-end gap-3">
                            <a href="#" style="color: rgba(255, 255, 255, 0.6); font-size: 1.5rem; transition: all 0.3s;" onmouseover="this.style.color='#16a34a'; this.style.transform='translateY(-3px)'" onmouseout="this.style.color='rgba(255, 255, 255, 0.6)'; this.style.transform='translateY(0)'" title="Facebook">
                                <i class="bi bi-facebook"></i>
                            </a>
                            <a href="#" style="color: rgba(255, 255, 255, 0.6); font-size: 1.5rem; transition: all 0.3s;" onmouseover="this.style.color='#16a34a'; this.style.transform='translateY(-3px)'" onmouseout="this.style.color='rgba(255, 255, 255, 0.6)'; this.style.transform='translateY(0)'" title="Instagram">
                                <i class="bi bi-instagram"></i>
                            </a>
                            <a href="#" style="color: rgba(255, 255, 255, 0.6); font-size: 1.5rem; transition: all 0.3s;" onmouseover="this.style.color='#16a34a'; this.style.transform='translateY(-3px)'" onmouseout="this.style.color='rgba(255, 255, 255, 0.6)'; this.style.transform='translateY(0)'" title="Twitter">
                                <i class="bi bi-twitter"></i>
                            </a>
                            <a href="#" style="color: rgba(255, 255, 255, 0.6); font-size: 1.5rem; transition: all 0.3s;" onmouseover="this.style.color='#16a34a'; this.style.transform='translateY(-3px)'" onmouseout="this.style.color='rgba(255, 255, 255, 0.6)'; this.style.transform='translateY(0)'" title="LinkedIn">
